...
export {default as iconSiren} from './icon/icon_siren.png';
export {default as iconEmail} from './icon/icon_email.png';
export {default as iconSns} from './icon/icon_sns.png';
export {default as iconIntroduce} from './icon/icon_introduce.png';
export {default as iconList} from './icon/icon_list.png';
export {default as iconMenu} from './icon/icon_menu.png';
export {default as iconSetting} from './icon/icon_setting.png';
